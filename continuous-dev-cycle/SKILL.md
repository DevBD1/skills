...
description: Establish, repair, or operate a repository's continuous development workflow. Use when Codex is asked to set up or standardize lightweight Scrum, backlog and sprint docs, changelog and release history, Conventional Commits, pull request templates, CI validation, versioning, release prep, release channels, tags, GitHub Actions releases, platform changelogs, or an end-to-end idea-to-release development cycle across one or more repositories.
---
...
- `docs/releases/` for versioning, release channels, tags, artifacts, deployments, and publishing rules.
...
- Update `CHANGELOG.md` for user-visible, operator-visible, or release-relevant changes.
- Use Conventional Commits by default: `type(scope): summary`.
- Use release prep PRs for version bumps, changelog finalization, deployment notes, and external release copy.
...
Read `references/release-models.md` before changing versioning, release tags, changelog movement, release notes, deployment records, or CI release workflows.
...
- Use GitHub release workflow templates only for repos whose release profile includes GitHub Releases or GitHub-hosted artifacts.
