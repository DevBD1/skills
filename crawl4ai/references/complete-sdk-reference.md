...
- API token of LLM provider <br/> eg: `api_token = "YOUR_PROVIDER_API_TOKEN"`
...
async def main():
    llm_strategy = LLMExtractionStrategy(
        llm_config = LLMConfig(provider="openai/gpt-4",api_token="YOUR_OPENAI_API_KEY")
